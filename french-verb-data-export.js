...
export const FRENCH_VERB_DATA = {
  ...
  DIFFICULTY_CONFIGS: {
    ...
    "Difficult": { 
      verbs: ["être", "avoir", "faire", "dire", "aller", "voir", "savoir", "pouvoir", "vouloir", "venir", "se laver", "se réveiller", "s'habiller"], // 13 verbs (10 regular + 6 reflexive total)
      timeFrames: ["Past", "Present", "Future"], 
      tenses: ["Passé Composé", "Imparfait", "Plus-que-parfait", "Passé Simple", "Présent", "Présent Progressif", "Futur Simple", "Futur Antérieur", "Futur Proche"],
      courseStructure: {
        units: [
          { name: "Unit 1: être (to be)", verb: "être", questions: 20 },
          { name: "Unit 2: avoir (to have)", verb: "avoir", questions: 20 },
