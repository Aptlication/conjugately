        ...
        {showBeginnerCourseModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 max-w-md w-full mx-4">
              ...
              <p className="text-slate-300 text-center mb-6">Pass each final exam (90%) to unlock the next course</p>
              <div className="space-y-3 mb-6">
                {["Present", "Past", "Future"].map((timeFrame, index) => {
                  ...
                  // Check if previous courses are completed (sequential requirement based on exam passing)
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-slate-300 text-sm mt-1">
                        {isLocked 
                          ? `Pass ${orderedTimeFrames[currentIndex - 1]} Course final exam first`
