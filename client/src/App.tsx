...
function App() {
  ...
  const VERB_MEANINGS = {
    ...
    "s'adapter": "to adapt",
    "se réjouir": "to be delighted/rejoice",
    "mettre": "to put/place/wear",
    "trouver": "to find",
    "croire": "to believe",
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8">
          <div className="mb-8">
            ...
            >
              ...
              <option value="Intermediate" className="bg-gray-800 text-white">🟡 Intermediate - 18 verbs (7 reflexive + 11 non-reflexive), Present, past, and future tenses</option>
              <option value="Advanced" className="bg-gray-800 text-white">🔴 Advanced - 23 verbs (12 non-reflexive + 11 reflexive), all tenses</option>
            </select>
          </div>
