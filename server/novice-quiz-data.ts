...
export const NOVICE_QUIZ_DATA: Record<string, Record<string, NoviceQuizQuestion[]>> = {
  ...
  "être": {
    "present": [
      ...
      {"question": "You (plural) are ready. (Présent)", "options": ["Vous êtes prêts.", "Vous es prêts.", "Vous sommes prêts.", "Vous serez prêts."], "answer": "A"},
  ...
  "faire": {
    "present": [
      ...
      {"question": "You are not doing the dishes. (Présent - Negative)", "options": ["Tu ne fais pas la vaisselle.", "Je ne fais pas la vaisselle.", "Il ne fait pas la vaisselle.", "Nous ne faisons pas la vaisselle."], "answer": "A"},
      ...
      {"question": "They are doing their homework. (Présent)", "options": ["Ils font leurs devoirs.", "Elles font leurs devoirs.", "Ils faisaient leurs devoirs.", "Ils feront leurs devoirs."], "answer": "A"},
      ...
      {"question": "You do a good job. (Présent)", "options": ["Tu fais un bon travail.", "Je fais un bon travail.", "Il fait un bon travail.", "Vous faites un bon travail."], "answer": "A"},
      ...
      {"question": "You are doing great work. (Présent)", "options": ["Tu fais un excellent travail.", "Je fais un excellent travail.", "Il fait un excellent travail.", "Vous faites un excellent travail."], "answer": "A"},
    ...
    "passé_composé": [
      ...
      {"question": "They did their homework. (Passé Composé)", "options": ["Ils ont fait leurs devoirs.", "Elles ont fait leurs devoirs.", "Ils avaient fait leurs devoirs.", "Ils feront leurs devoirs."], "answer": "A"},
      ...
      {"question": "You did a great job. (Passé Composé)", "options": ["Tu as fait un excellent travail.", "J'ai fait un excellent travail.", "Il a fait un excellent travail.", "Vous avez fait un excellent travail."], "answer": "A"},
      ...
      {"question": "You did great work yesterday. (Passé Composé)", "options": ["Tu as fait un excellent travail hier.", "J'ai fait un excellent travail hier.", "Il a fait un excellent travail hier.", "Vous avez fait un excellent travail hier."], "answer": "A"},
    ...
    "futur_simple": [
      ...
      {"question": "You will not do the dishes. (Futur Simple - Negative)", "options": ["Tu ne feras pas la vaisselle.", "Je ne ferai pas la vaisselle.", "Il ne fera pas la vaisselle.", "Nous ne ferons pas la vaisselle."], "answer": "A"},
      ...
      {"question": "They will do their homework. (Futur Simple)", "options": ["Ils feront leurs devoirs.", "Elles feront leurs devoirs.", "Ils feraient leurs devoirs.", "Ils faisaient leurs devoirs."], "answer": "A"},
      ...
      {"question": "You will do a great job. (Futur Simple)", "options": ["Tu feras un excellent travail.", "Je ferai un excellent travail.", "Il fera un excellent travail.", "Vous ferez un excellent travail."], "answer": "A"},
      ...
      {"question": "You will do great work tomorrow. (Futur Simple)", "options": ["Tu feras un excellent travail demain.", "Je ferai un excellent travail demain.", "Il fera un excellent travail demain.", "Vous ferez un excellent travail demain."], "answer": "A"},
  ...
  "avoir": {
    "present": [
      ...
      {"question": "You have many books. (Présent)", "options": ["Tu as beaucoup de livres.", "J'ai beaucoup de livres.", "Il a beaucoup de livres.", "Vous avez beaucoup de livres."], "answer": "A"},
      ...
      {"question": "You have great ideas. (Présent)", "options": ["Tu as de bonnes idées.", "J'ai de bonnes idées.", "Il a de bonnes idées.", "Vous avez de bonnes idées."], "answer": "A"},
