...
const QUESTION_CONTEXTS = {
  ...
  avoir: [
    ...
    { en: "You have / You are having time.", fr_context: "du temps", pronoun: "tu" },
    { en: "He has / He is having money.", fr_context: "de l'argent", pronoun: "il" },
    ...
    { en: "They have / They are having problems.", fr_context: "des problèmes", pronoun: "ils" },
  ...
  faire: [
    { en: "I do / I am doing homework.", fr_context: "mes devoirs", pronoun: "je" },
    { en: "You make / You are making dinner.", fr_context: "le dîner", pronoun: "tu" },
    { en: "He does / He is doing exercise.", fr_context: "du sport", pronoun: "il" },
    ...
    { en: "They do / They are doing work.", fr_context: "du travail", pronoun: "ils" },
  ...
  voir: [
    { en: "I see / I am seeing the problem.", fr_context: "le problème", pronoun: "je" },
    { en: "You see / You are seeing the movie.", fr_context: "le film", pronoun: "tu" },
    { en: "He sees / He is seeing his friend.", fr_context: "son ami", pronoun: "il" },
    ...
    { en: "They see / They are seeing the ocean.", fr_context: "l'océan", pronoun: "ils" },
  ...
  dire: [
    { en: "I say / I am saying hello.", fr_context: "bonjour", pronoun: "je" },
    { en: "You say / You are saying the truth.", fr_context: "la vérité", pronoun: "tu" },
    { en: "He says / He is saying yes.", fr_context: "oui", pronoun: "il" },
    ...
    { en: "They say / They are saying something.", fr_context: "quelque chose", pronoun: "ils" },
  ...
  savoir: [
    { en: "I know / I am knowing the answer.", fr_context: "la réponse", pronoun: "je" },
    { en: "You know / You are knowing French.", fr_context: "le français", pronoun: "tu" },
    { en: "He knows / He is knowing the way.", fr_context: "le chemin", pronoun: "il" },
    ...
    { en: "They know / They are knowing something.", fr_context: "quelque chose", pronoun: "ils" },
  ...
  pouvoir: [
    { en: "I can / I am able to swim.", fr_context: "nager", pronoun: "je" },
    { en: "You can / You are able to dance.", fr_context: "danser", pronoun: "tu" },
    { en: "He can / He is able to run.", fr_context: "courir", pronoun: "il" },
    ...
    { en: "They can / They are able to work.", fr_context: "travailler", pronoun: "ils" },
  ...
  vouloir: [
    { en: "I want / I am wanting coffee.", fr_context: "du café", pronoun: "je" },
    { en: "You want / You are wanting to go.", fr_context: "partir", pronoun: "tu" },
    { en: "He wants / He is wanting money.", fr_context: "de l'argent", pronoun: "il" },
    ...
    { en: "They want / They are wanting freedom.", fr_context: "la liberté", pronoun: "ils" },
  ...
  venir: [
    { en: "I come / I am coming home.", fr_context: "à la maison", pronoun: "je" },
    { en: "You come / You are coming early.", fr_context: "tôt", pronoun: "tu" },
    { en: "He comes / He is coming here.", fr_context: "ici", pronoun: "il" },
    ...
    { en: "They come / They are coming late.", fr_context: "en retard", pronoun: "ils" },
  ...
  aller: [
    ...
    { en: "You go / You are going home.", fr_context: "à la maison", pronoun: "tu" },
    { en: "He goes / He is going to work.", fr_context: "au travail", pronoun: "il" },
    ...
    { en: "They go / They are going to the beach.", fr_context: "à la plage", pronoun: "ils" },
  ...
  "se lever": [
    { en: "I get up / I am getting up early.", fr_context: "tôt", pronoun: "je" },
    { en: "You wake up / You are waking up late.", fr_context: "tard", pronoun: "tu" },
    { en: "He gets up / He is getting up at 7.", fr_context: "à 7 heures", pronoun: "il" },
    ...
    { en: "They get up / They are getting up first.", fr_context: "en premier", pronoun: "ils" },
  ...
  "s'appeler": [
    { en: "I am called / I am being called Marie.", fr_context: "Marie", pronoun: "je" },
    { en: "You are called / You are being called Paul.", fr_context: "Paul", pronoun: "tu" },
    { en: "He is called / He is being called Jean.", fr_context: "Jean", pronoun: "il" },
    ...
    { en: "They are called / They are being called teachers.", fr_context: "professeurs", pronoun: "ils" },
  ...
  "se sentir": [
    { en: "I feel / I am feeling good.", fr_context: "bien", pronoun: "je" },
    { en: "You feel / You are feeling tired.", fr_context: "fatigué(e)", pronoun: "tu" },
    { en: "He feels / He is feeling happy.", fr_context: "heureux", pronoun: "il" },
    ...
    { en: "They feel / They are feeling nervous.", fr_context: "nerveux", pronoun: "ils" },
  ...
  "se laver": [
    { en: "I wash / I am washing myself.", fr_context: "", pronoun: "je" },
    { en: "You wash / You are washing your hands.", fr_context: "les mains", pronoun: "tu" },
    { en: "He washes / He is washing his face.", fr_context: "le visage", pronoun: "il" },
    ...
    { en: "They wash / They are washing carefully.", fr_context: "soigneusement", pronoun: "ils" },
  ...
  "se réveiller": [
    { en: "I wake up / I am waking up early.", fr_context: "tôt", pronoun: "je" },
    { en: "You wake up / You are waking up late.", fr_context: "tard", pronoun: "tu" },
    { en: "He wakes up / He is waking up at dawn.", fr_context: "à l'aube", pronoun: "il" },
    ...
    { en: "They wake up / They are waking up refreshed.", fr_context: "reposés", pronoun: "ils" },
  ...
  "s'habiller": [
    { en: "I get dressed / I am getting dressed quickly.", fr_context: "rapidement", pronoun: "je" },
    { en: "You dress / You are dressing elegantly.", fr_context: "élégamment", pronoun: "tu" },
    { en: "He dresses / He is dressing for work.", fr_context: "pour le travail", pronoun: "il" },
    ...
    { en: "They dress / They are dressing casually.", fr_context: "décontracté", pronoun: "ils" },
  ...
  for (let i = 0; i < 20; i++) {
    ...
    if (normalizedTense === 'passé_composé') {
      ...
      englishQuestion = englishQuestion
        ...
        // Handle negative forms for imparfait - Fix "used to don't" constructions FIRST
        .replace(/I used to don't/g, 'I didn\'t use to')
        .replace(/You used to don't/g, 'You didn\'t use to')
        .replace(/He used to doesn't/g, 'He didn\'t use to')
        .replace(/She used to doesn't/g, 'She didn\'t use to')
        .replace(/We used to don't/g, 'We didn\'t use to')
        .replace(/You \(plural\) used to don't/g, 'You (plural) didn\'t use to')
        .replace(/They used to don't/g, 'They didn\'t use to')
        // Handle specific verb negations with "used to"
        .replace(/I don't say/g, 'I didn\'t use to say')
        .replace(/You don't say/g, 'You didn\'t use to say')
        .replace(/He doesn't say/g, 'He didn\'t use to say')
        .replace(/She doesn't say/g, 'She didn\'t use to say')
        .replace(/We don't say/g, 'We didn\'t use to say')
        .replace(/You \(plural\) don't say/g, 'You (plural) didn\'t use to say')
        .replace(/They don't say/g, 'They didn\'t use to say')
        .replace(/I don't know/g, 'I didn\'t use to know')
        .replace(/You don't know/g, 'You didn\'t use to know')
        .replace(/He doesn't know/g, 'He didn\'t use to know')
        .replace(/She doesn't know/g, 'She didn\'t use to know')
        .replace(/We don't know/g, 'We didn\'t use to know')
        .replace(/You \(plural\) don't know/g, 'You (plural) didn\'t use to know')
        .replace(/They don't know/g, 'They didn\'t use to know')
        .replace(/I don't want/g, 'I didn\'t use to want')
        .replace(/You don't want/g, 'You didn\'t use to want')
        .replace(/He doesn't want/g, 'He didn\'t use to want')
        .replace(/She doesn't want/g, 'She didn\'t use to want')
        .replace(/We don't want/g, 'We didn\'t use to want')
        .replace(/You \(plural\) don't want/g, 'You (plural) didn\'t use to want')
        .replace(/They don't want/g, 'They didn\'t use to want')
        .replace(/I don't come/g, 'I didn\'t use to come')
        .replace(/You don't come/g, 'You didn\'t use to come')
        .replace(/He doesn't come/g, 'He didn\'t use to come')
        .replace(/She doesn't come/g, 'She didn\'t use to come')
        .replace(/We don't come/g, 'We didn\'t use to come')
        .replace(/You \(plural\) don't come/g, 'You (plural) didn\'t use to come')
        .replace(/They don't come/g, 'They didn\'t use to come')
        .replace(/I don't go/g, 'I didn\'t use to go')
        .replace(/You don't go/g, 'You didn\'t use to go')
        .replace(/He doesn't go/g, 'He didn\'t use to go')
        .replace(/She doesn't go/g, 'She didn\'t use to go')
        .replace(/We don't go/g, 'We didn\'t use to go')
        .replace(/You \(plural\) don't go/g, 'You (plural) didn\'t use to go')
        .replace(/They don't go/g, 'They didn\'t use to go')
        .replace(/I don't see/g, 'I didn\'t use to see')
        .replace(/You don't see/g, 'You didn\'t use to see')
        .replace(/He doesn't see/g, 'He didn\'t use to see')
        .replace(/She doesn't see/g, 'She didn\'t use to see')
        .replace(/We don't see/g, 'We didn\'t use to see')
        .replace(/You \(plural\) don't see/g, 'You (plural) didn\'t use to see')
        .replace(/They don't see/g, 'They didn\'t use to see')
        .replace(/I don't make/g, 'I didn\'t use to make')
        .replace(/You don't make/g, 'You didn\'t use to make')
        .replace(/He doesn't make/g, 'He didn\'t use to make')
        .replace(/She doesn't make/g, 'She didn\'t use to make')
        .replace(/We don't make/g, 'We didn\'t use to make')
        .replace(/You \(plural\) don't make/g, 'You (plural) didn\'t use to make')
        .replace(/They don't make/g, 'They didn\'t use to make')
        .replace(/I don't do/g, 'I didn\'t use to do')
        .replace(/You don't do/g, 'You didn\'t use to do')
        .replace(/He doesn't do/g, 'He didn\'t use to do')
        .replace(/She doesn't do/g, 'She didn\'t use to do')
        .replace(/We don't do/g, 'We didn\'t use to do')
        .replace(/You \(plural\) don't do/g, 'You (plural) didn\'t use to do')
        .replace(/They don't do/g, 'They didn\'t use to do')
        // General negative forms for imparfait
