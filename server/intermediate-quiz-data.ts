...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "s'intéresser": {
    ...
    "passé_composé": [
      ...
      {"question": "Did we take an interest in literature?", "options": ["Nous sommes-nous intéressé(e)s à la littérature ?", "Nous avons intéressé à la littérature ?", "Nous nous sommes intéressé(e)s à la littérature ?", "Est-ce que nous nous sommes intéressé(e)s à la littérature ?"], "answer": "A"},
      ...
      {"question": "Did they (masculine) take an interest in sports?", "options": ["Ils ont intéressé aux sports ?", "Se sont-ils intéressés aux sports ?", "Se sont-ils intéressés aux sports ?", "Est-ce qu'ils se sont intéressés aux sports ?"], "answer": "C"},
