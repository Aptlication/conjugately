...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "s'intéresser": {
    "present": [
      ...
      {"question": "Does she take an interest in science?", "options": ["Elle s'intéresse à la science ?", "Elle intéresse à la science ?", "Elle est intéressée à la science ?", "Elle s'intéresse-t-elle à la science ?"], "answer": "D"},
