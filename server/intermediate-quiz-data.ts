...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "s'intéresser": {
    ...
    "passé_composé": [
      ...
      {"question": "Did you become interested in technology? (Formal/Plural)", "options": ["Vous avez intéressé à la technologie ?", "Vous êtes-vous intéressé(e)s à la technologie ?", "Vous vous êtes intéressé(e)s à la technologie ?", "Est-ce que vous vous êtes intéressé(e)s à la technologie ?"], "answer": "B"},
