...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "ouvrir": {
    ...
    "passé_composé": [
      ...
      {"question": "Did we open the window after lunch?", "options": ["Nous a ouvert la fenêtre après le déjeuner?", "Nous avons ouvert la fenêtre après le déjeuner?", "Nous sommes ouvert la fenêtre après le déjeuner?", "Nous avez ouvert la fenêtre après le déjeuner."], "answer": "B"}
    ],
    "futur_simple": [
  ...
  "fermer": {
    ...
    "passé_composé": [
      ...
      {"question": "We closed the same window.", "options": ["Nous a fermé la même fenêtre.", "Nous avons fermé la même fenêtre.", "Nous sommes fermé la même fenêtre.", "Nous avez fermé la même fenêtre."], "answer": "B"},
      ...
      {"question": "Did we close the door before leaving?", "options": ["Nous a fermé la porte avant de partir?", "Nous avons fermé la porte avant de partir.", "Nous sommes fermé la porte avant de partir.", "Nous avez fermé la porte avant de partir."], "answer": "B"}
    ],
    "futur_simple": [
  ...
  "s'intéresser": {
    "present": [
      {"question": "Do I take an interest in politics?", "options": ["Est-ce que je m'intéresse à la politique ?", "Je m'intéresse à la politique ?", "Je intéresse à la politique ?", "Je suis intéressé à la politique ?"], "answer": "A"},
      {"question": "Do you take an interest in music? (Informal)", "options": ["Tu intéresse à la musique ?", "Tu t'intéresses à la musique ?", "Est-ce que tu t'intéresses à la musique ?", "Tu es intéressé à la musique ?"], "answer": "B"},
      {"question": "Does he take an interest in art?", "options": ["Il s'intéresse à l'art ?", "Il intéresse à l'art ?", "Est-ce qu'il s'intéresse à l'art ?", "Il est intéressé à l'art ?"], "answer": "C"},
      {"question": "Does she take an interest in science?", "options": ["Elle s'intéresse à la science ?", "Elle intéresse à la science ?", "Elle est intéressée à la science ?", "Elle s'intéresse-t-elle à la science ?"], "answer": "A"},
      {"question": "Do we take an interest in literature?", "options": ["Est-ce que nous nous intéressons à la littérature ?", "Nous nous intéressons à la littérature ?", "Nous intéressons à la littérature ?", "Nous sommes intéressés à la littérature ?"], "answer": "A"},
      {"question": "Do you take an interest in technology? (Formal/Plural)", "options": ["Vous vous intéressez à la technologie ?", "Vous intéressez-vous à la technologie ?", "Vous intéressez à la technologie ?", "Vous êtes intéressés à la technologie ?"], "answer": "B"},
      {"question": "Do they (masculine) take an interest in sports?", "options": ["Ils s'intéressent aux sports ?", "Ils intéressent aux sports ?", "S'intéressent-ils aux sports ?", "Ils sont intéressés aux sports ?"], "answer": "C"},
      {"question": "Do they (feminine) take an interest in cooking?", "options": ["Elles s'intéressent à la cuisine ?", "Elles intéressent à la cuisine ?", "Elles sont intéressées à la cuisine ?", "Est-ce qu'elles s'intéressent à la cuisine ?"], "answer": "D"},
      {"question": "Don't I take an interest in history?", "options": ["Est-ce que je ne m'intéresse pas à l'histoire ?", "Je ne m'intéresse pas à l'histoire ?", "Je ne pas m'intéresse à l'histoire ?", "Je ne suis pas intéressé à l'histoire ?"], "answer": "A"},
      {"question": "Don't you take an interest in movies? (Informal)", "options": ["Tu ne t'intéresses pas aux films ?", "Ne t'intéresses-tu pas aux films ?", "Tu ne pas t'intéresses aux films ?", "Tu n'es pas intéressé aux films ?"], "answer": "B"},
      {"question": "Doesn't he take an interest in fashion?", "options": ["Il ne s'intéresse pas à la mode ?", "Il ne pas s'intéresse à la mode ?", "Ne s'intéresse-t-il pas à la mode ?", "Il n'est pas intéressé à la mode ?"], "answer": "C"},
      {"question": "Doesn't she take an interest in photography?", "options": ["Elle ne s'intéresse pas à la photographie ?", "Elle ne pas s'intéresse à la photographie ?", "Elle n'est pas intéressée à la photographie ?", "Est-ce qu'elle ne s'intéresse pas à la photographie ?"], "answer": "D"},
      {"question": "Don't we take an interest in languages?", "options": ["Ne nous intéressons-nous pas aux langues ?", "Nous ne nous intéressons pas aux langues ?", "Nous ne pas nous intéressons aux langues ?", "Nous ne sommes pas intéressés aux langues ?"], "answer": "A"},
      {"question": "Don't you take an interest in travel? (Formal/Plural)", "options": ["Vous ne vous intéressez pas au voyage ?", "Est-ce que vous ne vous intéressez pas au voyage ?", "Vous ne pas vous intéressez au voyage ?", "Vous n'êtes pas intéressés au voyage ?"], "answer": "B"},
      {"question": "Don't they take an interest in mathematics?", "options": ["Ils ne s'intéressent pas aux mathématiques ?", "Ils ne pas s'intéressent aux mathématiques ?", "Ne s'intéressent-ils pas aux mathématiques ?", "Ils ne sont pas intéressés aux mathématiques ?"], "answer": "C"},
      {"question": "What do I take an interest in?", "options": ["À quoi je m'intéresse ?", "Quoi je m'intéresse ?", "Qu'est-ce que je m'intéresse ?", "À quoi est-ce que je m'intéresse ?"], "answer": "D"},
      {"question": "What do you take an interest in? (Informal)", "options": ["À quoi t'intéresses-tu ?", "À quoi tu t'intéresses ?", "Quoi tu t'intéresses ?", "Qu'est-ce que tu t'intéresses ?"], "answer": "A"},
      {"question": "What does he take an interest in?", "options": ["À quoi il s'intéresse ?", "À quoi s'intéresse-t-il ?", "Quoi il s'intéresse ?", "Qu'est-ce qu'il s'intéresse ?"], "answer": "B"},
      {"question": "Why do we take an interest in this?", "options": ["Pourquoi nous nous intéressons à cela ?", "Pourquoi nous intéressons à cela ?", "Pourquoi nous intéressons-nous à cela ?", "Pourquoi sommes-nous intéressés à cela ?"], "answer": "C"},
      {"question": "How do they take an interest in everything?", "options": ["Comment ils s'intéressent à tout ?", "Comment ils intéressent à tout ?", "Comment sont-ils intéressés à tout ?", "Comment s'intéressent-ils à tout ?"], "answer": "D"}
    ],
    "passé_composé": [
      {"question": "Did I take an interest in music?", "options": ["Me suis-je intéressé(e) à la musique ?", "Ai-je intéressé à la musique ?", "Est-ce que je me suis intéressés à la musique ?", "Je suis m'intéressé à la musique ?"], "answer": "A"},
      {"question": "Weren't you interested in history? (Informal)", "options": ["Tu t'es intéressé(e) à l'histoire ?", "Ne t'es-tu pas intéressé(e) à l'histoire ?", "Ne t'as-tu pas intéressé(e) à l'histoire ?", "T'as-tu intéressé à l'histoire ?"], "answer": "B"},
      {"question": "Did he take an interest in politics?", "options": ["S'est-il intéressé à la politique ?", "A-t-il intéressé à la politique ?", "Est-ce qu'il s'est intéressé à la politique ?", "Il s'est intéressé à la politique ?"], "answer": "C"},
      {"question": "Did she become interested in science?", "options": ["Elle s'est intéressée à la science ?", "S'est-elle intéressée à la science ?", "A-t-elle intéressé à la science ?", "Est-ce qu'elle s'est intéressée à la science ?"], "answer": "D"},
      {"question": "Did we take an interest in literature?", "options": ["Nous sommes-nous intéressé(e)s à la littérature ?", "Nous avons intéressé à la littérature ?", "Nous nous sommes intéressé(e)s à la littérature ?", "Est-ce que nous nous sommes intéressé(e)s à la littérature ?"], "answer": "D"},
      {"question": "Did you become interested in technology? (Formal/Plural)", "options": ["Vous avez intéressé à la technologie ?", "Vous êtes-vous intéressé(e)s à la technologie ?", "Vous vous êtes intéressé(e)s à la technologie ?", "Est-ce que vous vous êtes intéressé(e)s à la technologie ?"], "answer": "D"},
      {"question": "Did they (masculine) take an interest in sports?", "options": ["Ils ont intéressé aux sports ?", "Se sont-ils intéressés aux sports ?", "Ils se sont intéressés aux sports ?", "Est-ce qu'ils se sont intéressés aux sports ?"], "answer": "D"},
      {"question": "Did they (feminine) become interested in cooking?", "options": ["Elles ont intéressé à la cuisine ?", "Elles se sont intéressées à la cuisine ?", "Se sont-elles intéressées à la cuisine ?", "Est-ce qu'elles se sont intéressées à la cuisine ?"], "answer": "D"},
      {"question": "Didn't I take an interest in art?", "options": ["Ne me suis-je pas intéressé(e) à l'art ?", "N'ai-je pas intéressé à l'art ?", "Est-ce que je ne me suis pas intéressé(e) à l'art ?", "Je ne me suis pas intéressé(e) à l'art ?"], "answer": "A"},
      {"question": "Didn't you become interested in movies? (Informal)", "options": ["Tu ne t'es pas intéressé(e) aux films ?", "Ne t'es-tu pas intéressé(e) aux films ?", "N'as-tu pas intéressé aux films ?", "Est-ce que tu ne t'es pas intéressé(e) aux films ?"], "answer": "B"},
      {"question": "Didn't he take an interest in fashion?", "options": ["Il ne s'est pas intéressé à la mode ?", "N'a-t-il pas intéressé à la mode ?", "Ne s'est-il pas intéressé à la mode ?", "Est-ce qu'il ne s'est pas intéressé à la mode ?"], "answer": "C"},
      {"question": "Didn't she become interested in photography?", "options": ["Elle ne s'est pas intéressée à la photographie ?", "N'a-t-elle pas intéressé à la photographie ?", "Ne s'est-elle pas intéressée à la photographie ?", "Est-ce qu'elle ne s'est pas intéressée à la photographie ?"], "answer": "D"},
      {"question": "Didn't we take an interest in languages?", "options": ["Ne nous sommes-nous pas intéressé(e)s aux langues ?", "Nous ne nous sommes pas intéressé(e)s aux langues ?", "N'avons-nous pas intéressé aux langues ?", "Est-ce que nous ne nous sommes pas intéressé(e)s aux langues ?"], "answer": "A"},
      {"question": "Didn't you become interested in travel? (Formal/Plural)", "options": ["Vous ne vous êtes pas intéressé(e)s au voyage ?", "Ne vous êtes-vous pas intéressé(e)s au voyage ?", "N'avez-vous pas intéressé au voyage ?", "Est-ce que vous ne vous êtes pas intéressé(e)s au voyage ?"], "answer": "B"},
      {"question": "Didn't they take an interest in mathematics?", "options": ["Ils ne se sont pas intéressés aux mathématiques ?", "N'ont-ils pas intéressé aux mathématiques ?", "Ne se sont-ils pas intéressés aux mathématiques ?", "Est-ce qu'ils ne se sont pas intéressés aux mathématiques ?"], "answer": "C"},
      {"question": "When did I become interested in books?", "options": ["Quand je me suis intéressé(e) aux livres ?", "Quand ai-je intéressé aux livres ?", "Quand est-ce que je me suis intéressé(e) aux livres ?", "Quand me suis-je intéressé(e) aux livres ?"], "answer": "D"},
      {"question": "What did you become interested in? (Informal)", "options": ["À quoi t'es-tu intéressé(e) ?", "À quoi tu t'es intéressé(e) ?", "À quoi as-tu intéressé ?", "À quoi est-ce que tu t'es intéressé(e) ?"], "answer": "D"},
      {"question": "Where did he take an interest?", "options": ["Où il s'est intéressé ?", "Où s'est-il intéressé ?", "Où a-t-il intéressé ?", "Où est-ce qu'il s'est intéressé ?"], "answer": "B"},
      {"question": "Why did we become interested in this subject?", "options": ["Pourquoi nous nous sommes intéressé(e)s à ce sujet ?", "Pourquoi avons-nous intéressé à ce sujet ?", "Pourquoi nous sommes-nous intéressé(e)s à ce sujet ?", "Pourquoi est-ce que nous nous sommes intéressé(e)s à ce sujet ?"], "answer": "C"},
      {"question": "How did they become interested in everything?", "options": ["Comment ils se sont intéressés à tout ?", "Comment ont-ils intéressé à tout ?", "Comment est-ce qu'ils se sont intéressés à tout ?", "Comment se sont-ils intéressés à tout ?"], "answer": "D"}
    ],
    "futur_simple": [
  ...
  "se débrouiller": {
    "present": [
      ...
      {"question": "Are you (singular) managing well?", "options": ["Est-ce que tu débrouilles bien ?", "Est-ce que tu te débrouilles bien ?", "Est-ce que tu te débrouille bien ?", "Est-ce que tu me débrouilles bien ?"], "answer": "B"},
      {"question": "Is he not managing at all?", "options": ["Est-ce qu'il se débrouille pas du tout ?", "Est-ce qu'il ne débrouille pas du tout ?", "Est-ce qu'il ne se débrouille pas du tout ?", "Est-ce qu'il se ne débrouille pas du tout ?"], "answer": "C"},
      {"question": "Are we managing fine?", "options": ["Est-ce que nous débrouillons bien ?", "Est-ce que nous se débrouillons bien ?", "Nous nous débrouillons bien ?", "Est-ce que nous nous débrouillons bien ?"], "answer": "D"},
      {"question": "Does she manage on her own?", "options": ["Elle se débrouille toute seule ?", "Débrouille-t-elle toute seule ?", "Est-ce qu'elle débrouille toute seule ?", "Se débrouille-t-elle toute seule ?"], "answer": "A"},
      {"question": "You (plural) manage very well.", "options": ["Vous débrouillez très bien.", "Vous vous débrouillez très bien.", "Vous vous débrouillons très bien.", "Vous se débrouillez très bien."], "answer": "B"},
      {"question": "They (masculine) do not manage without help.", "options": ["Ils se débrouillent pas sans aide.", "Ils ne débrouillent pas sans aide.", "Ils ne se débrouillent pas sans aide.", "Ils se ne débrouillent pas sans aide."], "answer": "C"},
      {"question": "Do you (formal) manage alright?", "options": ["Vous débrouillez-vous bien ?", "Est-ce que vous débrouillez bien ?", "Vous vous débrouillez bien ?", "Est-ce que vous vous débrouillez bien ?"], "answer": "D"},
      ...
      {"question": "Don't we manage without problems?", "options": ["Est-ce que nous nous débrouillons sans problèmes ?", "Ne nous débrouillons-nous pas sans problèmes ?", "Nous nous débrouillons sans problèmes ?", "Nous ne nous débrouillons pas sans problèmes ?"], "answer": "B"},
      {"question": "I do not manage alone.", "options": ["Je me débrouille pas seul(e).", "Je ne débrouille pas seul(e).", "Je ne me débrouille pas seul(e).", "Je se ne débrouille pas seul(e)."], "answer": "C"},
      {"question": "She manages perfectly.", "options": ["Elle débrouille parfaitement.", "Elle se débrouilles parfaitement.", "Elle ne se débrouille pas parfaitement.", "Elle se débrouille parfaitement."], "answer": "D"},
      ...
      {"question": "Don't you (singular) manage well?", "options": ["Tu te débrouilles pas bien ?", "Tu ne te débrouilles pas bien ?", "Ne te débrouilles-tu pas bien ?", "Ne te débrouille-tu pas bien ?"], "answer": "B"},
      {"question": "He does not manage without help.", "options": ["Il se débrouille pas sans aide.", "Il ne débrouille pas sans aide.", "Il ne se débrouille pas sans aide.", "Il se ne débrouille pas sans aide."], "answer": "C"},
      {"question": "You (plural) manage everything alone.", "options": ["Vous débrouillez tout seuls.", "Vous vous débrouillons tout seuls.", "Vous se débrouillez tout seuls.", "Vous vous débrouillez tout seuls."], "answer": "D"},
      ...
      {"question": "How do I manage this?", "options": ["Comment je débrouille avec ça ?", "Comment est-ce que je me débrouille avec ça ?", "Comment je me débrouille avec ça ?", "Comment est-ce que je débrouille avec ça ?"], "answer": "B"},
      {"question": "They (masculine) do not manage alone.", "options": ["Ils se débrouillent pas seuls.", "Ils ne débrouillent pas seuls.", "Ils ne se débrouillent pas seuls.", "Ils se ne débrouillent pas seuls."], "answer": "C"},
      {"question": "They (feminine) manage without problems.", "options": ["Elles débrouillent sans problèmes.", "Elles se débrouillons sans problèmes.", "Elles ne se débrouillent pas sans problèmes.", "Elles se débrouillent sans problèmes."], "answer": "D"}
    ],
    "passé_composé": [
      {"question": "Did I manage on my own?", "options": ["Me suis-je débrouillé(e) tout(e) seul(e) ?", "M'ai-je débrouillé(e) tout(e) seul(e) ?", "Me suis-je débrouiller tout(e) seul(e) ?", "Ai-je débrouillé tout(e) seul(e) ?"], "answer": "A"},
      {"question": "Did you (singular) manage well?", "options": ["Est-ce que tu as bien débrouillé ?", "Est-ce que tu t'es bien débrouillé(e) ?", "Est-ce que tu es bien débrouillé(e) ?", "Est-ce que tu t'as bien débrouillé(e) ?"], "answer": "B"},
      {"question": "He did not manage at all.", "options": ["Il s'est pas débrouillé du tout.", "Il n'a pas débrouillé du tout.", "Il ne s'est pas débrouillé du tout.", "Il se n'est pas débrouillé du tout."], "answer": "C"},
      {"question": "We managed fine.", "options": ["Nous avons bien débrouillé.", "Nous nous avons bien débrouillés.", "Nous sommes bien débrouillés.", "Nous nous sommes bien débrouillés."], "answer": "D"},
      {"question": "She managed on her own.", "options": ["Elle s'est débrouillée toute seule.", "Elle s'est débrouillé toute seule.", "Elle a débrouillé toute seule.", "Elle est débrouillée toute seule."], "answer": "A"},
      {"question": "You (plural) managed very well.", "options": ["Vous avez très bien débrouillé.", "Vous vous êtes très bien débrouillés.", "Vous vous avez très bien débrouillés.", "Vous êtes très bien débrouillés."], "answer": "B"},
      {"question": "They (masculine) did not manage without help.", "options": ["Ils se sont pas débrouillés sans aide.", "Ils n'ont pas débrouillé sans aide.", "Ils ne se sont pas débrouillés sans aide.", "Ils se ne sont pas débrouillés sans aide."], "answer": "C"},
      {"question": "Did you (formal) manage alright?", "options": ["Avez-vous bien débrouillé ?", "Vous vous avez bien débrouillé(e) ?", "Êtes-vous bien débrouillé(e) ?", "Vous êtes-vous bien débrouillé(e) ?"], "answer": "D"},
      {"question": "Did they (feminine) manage alone?", "options": ["Se sont-elles débrouillées seules ?", "Ont-elles débrouillé seules ?", "Sont-elles débrouillées seules ?", "Se sont-elles débrouillé seules ?"], "answer": "A"},
      {"question": "Didn't we manage without problems?", "options": ["Nous nous sommes pas débrouillés sans problèmes ?", "Ne nous sommes-nous pas débrouillés sans problèmes ?", "N'avons-nous pas débrouillé sans problèmes ?", "Ne nous avons-nous pas débrouillés sans problèmes ?"], "answer": "B"},
      {"question": "I did not manage alone.", "options": ["Je me suis pas débrouillé(e) seul(e).", "Je n'ai pas débrouillé seul(e).", "Je ne me suis pas débrouillé(e) seul(e).", "Je me ne suis pas débrouillé(e) seul(e)."], "answer": "C"},
      {"question": "She managed perfectly.", "options": ["Elle a débrouillé parfaitement.", "Elle s'est débrouillé parfaitement.", "Elle est débrouillée parfaitement.", "Elle s'est débrouillée parfaitement."], "answer": "D"},
      {"question": "We managed together.", "options": ["Nous nous sommes débrouillés ensemble.", "Nous avons débrouillé ensemble.", "Nous nous avons débrouillés ensemble.", "Nous sommes débrouillés ensemble."], "answer": "A"},
      {"question": "Didn't you (singular) manage well?", "options": ["Tu t'es pas bien débrouillé(e) ?", "Ne t'es-tu pas bien débrouillé(e) ?", "N'as-tu pas bien débrouillé ?", "Ne t'as-tu pas bien débrouillé(e) ?"], "answer": "B"},
      {"question": "He did not manage without help.", "options": ["Il s'est pas débrouillé sans aide.", "Il n'est pas débrouillé sans aide.", "Il ne s'est pas débrouillé sans aide.", "Il se n'est pas débrouillé sans aide."], "answer": "C"},
      {"question": "You (plural) managed everything alone.", "options": ["Vous avez débrouillé tout seuls.", "Vous vous avez débrouillés tout seuls.", "Vous êtes débrouillés tout seuls.", "Vous vous êtes débrouillés tout seuls."], "answer": "D"},
      {"question": "Did they (masculine) manage well?", "options": ["Se sont-ils bien débrouillés ?", "Ont-ils bien débrouillé ?", "Sont-ils bien débrouillés ?", "Se sont-ils bien débrouillé ?"], "answer": "A"},
      {"question": "How did I manage with that?", "options": ["Comment est-ce que j'ai débrouillé avec ça ?", "Comment est-ce que je me suis débrouillé(e) avec ça ?", "Comment je me suis débrouiller avec ça ?", "Comment est-ce que je suis débrouillé(e) avec ça ?"], "answer": "B"},
      {"question": "They (masculine) did not manage alone.", "options": ["Ils se sont pas débrouillés seuls.", "Ils n'ont pas débrouillé seuls.", "Ils ne se sont pas débrouillés seuls.", "Ils se ne sont pas débrouillés seuls."], "answer": "C"},
      {"question": "They (feminine) managed without problems.", "options": ["Elles ont débrouillé sans problèmes.", "Elles se sont débrouillé sans problèmes.", "Elles sont débrouillées sans problèmes.", "Elles se sont débrouillées sans problèmes."], "answer": "D"}
    ],
    "futur_simple": [
      {"question": "Will I manage on my own?", "options": ["Est-ce que je me débrouillerai tout(e) seul(e) ?", "Est-ce que je débrouillerai tout(e) seul(e) ?", "Est-ce que je me débrouillerais tout(e) seul(e) ?", "Est-ce que je me débrouillera tout(e) seul(e) ?"], "answer": "A"},
      {"question": "Will you (singular) manage well?", "options": ["Est-ce que tu débrouilleras bien ?", "Est-ce que tu te débrouilleras bien ?", "Est-ce que tu te débrouillera bien ?", "Est-ce que tu me débrouilleras bien ?"], "answer": "B"},
      {"question": "He will not manage at all.", "options": ["Il se débrouillera pas du tout.", "Il ne débrouillera pas du tout.", "Il ne se débrouillera pas du tout.", "Il se ne débrouillera pas du tout."], "answer": "C"},
      {"question": "We will manage fine.", "options": ["Nous débrouillerons bien.", "Nous se débrouillerons bien.", "Nous nous débrouillerions bien.", "Nous nous débrouillerons bien."], "answer": "D"},
      {"question": "She will manage on her own.", "options": ["Elle se débrouillera toute seule.", "Elle débrouillera toute seule.", "Elle se débrouilleras toute seule.", "Elle se débrouilleront toute seule."], "answer": "A"},
      {"question": "You (plural) will manage very well.", "options": ["Vous débrouillerez très bien.", "Vous vous débrouillerez très bien.", "Vous vous débrouillerons très bien.", "Vous se débrouillerez très bien."], "answer": "B"},
      {"question": "They (masculine) will not manage without help.", "options": ["Ils se débrouilleront pas sans aide.", "Ils ne débrouilleront pas sans aide.", "Ils ne se débrouilleront pas sans aide.", "Ils se ne débrouilleront pas sans aide."], "answer": "C"},
      {"question": "Will you (formal) manage alright?", "options": ["Débrouillerez-vous bien ?", "Vous vous débrouillera bien ?", "Est-ce que vous débrouillerez bien ?", "Vous débrouillerez-vous bien ?"], "answer": "D"},
      {"question": "Will they (feminine) manage alone?", "options": ["Se débrouilleront-elles seules ?", "Débrouilleront-elles seules ?", "Se débrouillera-t-elles seules ?", "Elles débrouilleront seules ?"], "answer": "A"},
      {"question": "Won't we manage without problems?", "options": ["Nous nous débrouillerons pas sans problèmes ?", "Ne nous débrouillerons-nous pas sans problèmes ?", "Ne débrouillerons-nous pas sans problèmes ?", "Ne nous débrouillerions-nous pas sans problèmes ?"], "answer": "B"},
      {"question": "I will not manage alone.", "options": ["Je me débrouillerai pas seul(e).", "Je ne débrouillerai pas seul(e).", "Je ne me débrouillerai pas seul(e).", "Je me ne débrouillerai pas seul(e)."], "answer": "C"},
      {"question": "She will manage perfectly.", "options": ["Elle débrouillera parfaitement.", "Elle se débrouilleras parfaitement.", "Elle se débrouillerait parfaitement.", "Elle se débrouillera parfaitement."], "answer": "D"},
      {"question": "We will manage together.", "options": ["Nous nous débrouillerons ensemble.", "Nous débrouillerons ensemble.", "Nous se débrouillerons ensemble.", "Nous nous débrouilleront ensemble."], "answer": "A"},
      {"question": "Won't you (singular) manage well?", "options": ["Tu te débrouilleras pas bien ?", "Ne te débrouilleras-tu pas bien ?", "Ne débrouilleras-tu pas bien ?", "Ne te débrouillera-tu pas bien ?"], "answer": "B"},
      {"question": "He will not manage without help.", "options": ["Il se débrouillera pas sans aide.", "Il ne débrouillera pas sans aide.", "Il ne se débrouillera pas sans aide.", "Il se ne débrouillera pas sans aide."], "answer": "C"},
      {"question": "You (plural) will manage everything alone.", "options": ["Vous débrouillerez tout seuls.", "Vous vous débrouillerons tout seuls.", "Vous se débrouillerez tout seuls.", "Vous vous débrouillerez tout seuls."], "answer": "D"},
      {"question": "Will they (masculine) manage well?", "options": ["Se débrouilleront-ils bien ?", "Débrouilleront-ils bien ?", "Se débrouillera-t-ils bien ?", "Ils débrouilleront bien ?"], "answer": "A"},
      {"question": "How will I manage with that?", "options": ["Comment est-ce que je débrouillerai avec ça ?", "Comment est-ce que je me débrouillerai avec ça ?", "Comment je me débrouillera avec ça ?", "Comment est-ce que je me débrouillerais avec ça ?"], "answer": "B"},
      {"question": "They (masculine) will not manage alone.", "options": ["Ils se débrouilleront pas seuls.", "Ils ne débrouilleront pas seuls.", "Ils ne se débrouilleront pas seuls.", "Ils se ne débrouilleront pas seuls."], "answer": "C"},
      {"question": "They (feminine) will manage without problems.", "options": ["Elles débrouilleront sans problèmes.", "Elles se débrouillerons sans problèmes.", "Elles se débrouilleraient sans problèmes.", "Elles se débrouilleront sans problèmes."], "answer": "D"}
    ]
  },
  ...
  "s'entraîner": {
    "present": [
      ...
      {"question": "Is he training?", "options": ["S'entraîne-t-il ?", "Il s'entraîne ?", "Il entraîne ?", "Il s'entraînes ?"], "answer": "A"},
      {"question": "Are we not training?", "options": ["Ne nous entraînons-nous pas ?", "Nous nous entraînons pas ?", "Nous entraînons ?", "Nous s'entraînons ?"], "answer": "A"},
      {"question": "Is she training?", "options": ["Elle s'entraîne ?", "S'entraîne-t-elle ?", "Elle entraîne ?", "Elle s'entraînes ?"], "answer": "A"},
      {"question": "You (vous) are training.", "options": ["Vous vous entraînez.", "Vous entraînez ?", "Vous vous entraîneurs.", "Vous avez entraîné ?"], "answer": "A"},
      {"question": "They (masc.) are not training.", "options": ["Ils ne s'entraînent pas.", "Ils n'entraînent pas.", "Ne s'entraînent-ils pas ?", "Ils s'entraînent ?"], "answer": "A"},
      {"question": "Are you (vous) training?", "options": ["Vous vous entraînez ?", "Vous entraînez-vous ?", "Vous vous êtes entraîné ?", "Vous entraînez ?"], "answer": "A"},
      ...
      {"question": "I am not training.", "options": ["Je ne m'entraîne pas.", "Je m'entraîne ?", "J'entraîne pas.", "Je me suis entraîné."], "answer": "A"},
      {"question": "She is training.", "options": ["Elle s'entraîne.", "Elle entraîne ?", "Elle s'entraîne pas.", "Elle s'est entraînée."], "answer": "A"},
      ...
      {"question": "She is not training.", "options": ["Elle ne s'entraîne pas.", "Elle entraîne pas.", "Elle s'entraîne pas.", "Elle ne entraîne pas."], "answer": "A"},
      {"question": "You (vous) are not training.", "options": ["Vous ne vous entraînez pas.", "Vous entraînez pas.", "Vous vous entraînez ?", "Vous avez entraîné ?"], "answer": "A"},
      {"question": "He is not training.", "options": ["Il ne s'entraîne pas.", "Il s'entraîne pas.", "Il entraîne pas.", "Il s'entraîne ?"], "answer": "A"},
      {"question": "They (masc.) are training.", "options": ["Ils s'entraînent.", "Ils entraînent ?", "Ils ne s'entraînent pas.", "Ils entraînent pas ?"], "answer": "A"},
      {"question": "Is she not training?", "options": ["Ne s'entraîne-t-elle pas ?", "Elle s'entraîne pas ?", "Elle ne entraîne pas ?", "S'est-elle entraînée ?"], "answer": "A"},
      {"question": "They (fem.) are not training.", "options": ["Elles ne s'entraînent pas.", "Elles s'entraînent pas.", "Elles entraînent pas.", "Elles s'entraînent ?"], "answer": "A"}
    ],
    "passé_composé": [
    ...
    "futur_simple": [
      ...
      {"question": "Will she not train?", "options": ["Ne s'entraînera-t-elle pas ?", "Elle s'entraînera pas ?", "Elle ne entraînera pas ?", "S'est-elle entraînée ?"], "answer": "A"},
      {"question": "They (fem.) will not train.", "options": ["Elles ne s'entraîneront pas.", "Elles s'entraîneront pas.", "Elles entraîneront pas.", "Elles s'entraîneront ?"], "answer": "A"}
    ]
  },
  ...
  "s'ennuyer": {
    "present": [
      ...
      {"question": "Is he not bored?", "options": ["Ne s'ennuie-t-il pas ?", "Il ne s'ennuie pas ?", "Il s'ennuie ?", "Il ennuie ?"], "answer": "B"},
      {"question": "Are we bored?", "options": ["Nous ennuyons ?", "Nous s'ennuyons ?", "Nous nous ennuyons ?", "Est-ce que nous nous ennuyons ?"], "answer": "C"},
      {"question": "Are you (plural) not bored?", "options": ["Vous vous ennuyez ?", "Est-ce que vous vous ennuyez ?", "Ne vous ennuyez-vous pas ?", "Vous ne vous ennuyez pas ?"], "answer": "D"},
      ...
      {"question": "We are not bored.", "options": ["Nous nous ennuyons.", "Nous ennuyons pas.", "Nous ne nous ennuyons pas.", "Nous s'ennuions pas."], "answer": "C"},
      ...
      {"question": "Are you (plural) not bored?", "options": ["Vous vous ennuyez ?", "Vous ne vous ennuyez pas ?", "Vous ne ennuyiez pas ?", "Vous ennuyez ?"], "answer": "B"},
      {"question": "I am not bored.", "options": ["Je m'ennuie.", "Je ennuyé.", "Je ne m'ennuie pas.", "Je suis ennuyé."], "answer": "C"},
      {"question": "She is not bored.", "options": ["Elle s'ennuie.", "Elle n'est pas ennuyée.", "Elle est ennuyée.", "Elle ne s'ennuie pas."], "answer": "D"},
      {"question": "We are bored.", "options": ["Nous nous ennuyons.", "Nous s'ennuyons.", "Nous ennuyons.", "Nous ne nous ennuyons pas."], "answer": "A"},
      {"question": "Are you (singular) not bored?", "options": ["Tu ennuyé ?", "Ne t'ennuies-tu pas ?", "Tu ne t'ennuies pas ?", "Tu ne ennuyé pas ?"], "answer": "B"},
      {"question": "He is not bored.", "options": ["Il s'ennuie.", "Il ennuyé.", "Il ne s'ennuie pas.", "Il ennui."], "answer": "C"},
      ...
      {"question": "Am I bored?", "options": ["Je ennuyé ?", "Est-ce que je m'ennuie ?", "Je m'ennuie ?", "Je ennuie ?"], "answer": "B"},
      {"question": "They (masculine) are not bored.", "options": ["Ils s'ennuient.", "Ils sont ennuyés.", "Ils ne s'ennuient pas.", "Ils ennuient."], "answer": "C"},
  ...
  "se souvenir": {
    ...
    "futur_simple": [
      ...
      {"question": "Will we not remember?", "options": ["Nous ne nous souviendrons pas?", "Ne nous souviendrons-nous pas?", "Nous nous souviendrons?", "Nous souviendrons?"], "answer": "B"},
      {"question": "I will not remember.", "options": ["Je me souviendrai?", "Je souviendrai pas.", "Je ne me souviendrai pas.", "Je me suis souvenu."], "answer": "C"},
      {"question": "She will remember.", "options": ["Elle souviendra?", "Elle se souviendra pas.", "Elle s'est souvenue.", "Elle se souviendra."], "answer": "D"},
      ...
      {"question": "Will you (tu) not remember?", "options": ["Tu ne te souviendras pas?", "Ne te souviendras-tu pas?", "Tu souviendras pas?", "Tu te souviendras?"], "answer": "B"},
      {"question": "She will not remember.", "options": ["Elle souviendra pas.", "Elle se souviendra pas.", "Elle ne se souviendra pas.", "Elle ne souviendra pas."], "answer": "C"},
      {"question": "You (vous) will not remember.", "options": ["Vous souviendrez pas.", "Vous vous souviendrez?", "Vous avez souvenu?", "Vous ne vous souviendrez pas."], "answer": "D"},
      ...
      {"question": "They (masc.) will remember.", "options": ["Ils souviendront?", "Ils se souviendront.", "Ils ne se souviendront pas.", "Ils souviendront pas?"], "answer": "B"},
      {"question": "Will she not remember?", "options": ["Elle se souviendra pas?", "Elle ne souviendra pas?", "Ne se souviendra-t-elle pas?", "S'est-elle souvenue?"], "answer": "C"},
      {"question": "They (fem.) will not remember.", "options": ["Elles se souviendront pas.", "Elles souviendront pas.", "Elles se souviendront?", "Elles ne se souviendront pas."], "answer": "D"}
    ]
  },

  "s'adapter": {
    "present": [
      {"question": "Do I adapt?", "options": ["Je m'adapte?", "M'adapte-je?", "Je m'adaptez?", "Je adapte?"], "answer": "A"},
      ...
      {"question": "You (vous) adapt.", "options": ["Vous vous adaptez.", "Vous adaptez-vous?", "Vous adaptez?", "Vous avez adapté?"], "answer": "A"},
      ...
      {"question": "Do you (vous) adapt?", "options": ["Adaptez-vous?", "Vous vous adaptez?", "Vous adaptez?", "Vous vous êtes adaptés?"], "answer": "B"},
      ...
      {"question": "I do not adapt.", "options": ["Je ne m'adapte pas.", "Je m'adapte pas.", "Je m'adapte?", "Je ne m'adaptes pas."], "answer": "A"},
      {"question": "She adapts.", "options": ["Elle s'adapte.", "Adapte-t-elle?", "Elle adapte?", "Elle ne s'adapte pas."], "answer": "A"},
      ...
      {"question": "You (vous) do not adapt.", "options": ["Vous ne vous adaptez pas.", "Vous adaptez-vous pas?", "Vous adaptez?", "Vous avez adapté?"], "answer": "A"},
      ...
      {"question": "Does she not adapt?", "options": ["Ne s'adapte-t-elle pas?", "Elle s'adapte pas?", "S'est-elle adaptée?", "Elle ne adapte pas?"], "answer": "A"},
    ...
    "futur_simple": [
      ...
      {"question": "Will she adapt?", "options": ["Se adaptera-t-elle?", "Elle s'adaptera?", "Elle adaptera?", "Elle s'adapterait?"], "answer": "B"},
      {"question": "You (vous) will adapt.", "options": ["Vous vous adapterez.", "Adapterez-vous?", "Vous adapterez?", "Vous avez adapté?"], "answer": "A"},
      ...
      {"question": "Will you (vous) adapt?", "options": ["Adapterez-vous?", "Vous vous adapterez?", "Vous adapterez?", "Vous vous êtes adaptés?"], "answer": "A"},
      ...
      {"question": "I will not adapt.", "options": ["Je ne m'adapterai pas.", "Je m'adapterai pas.", "Je m'adapterai?", "Je n'ai pas adapté."], "answer": "A"},
  ...
  "se réjouir": {
    "present": [
      {"question": "Do I rejoice?", "options": ["Je me réjouis?", "Me réjouis-je?", "Je me réjouissez?", "Je réjouis?"], "answer": "A"},
      {"question": "Do you (tu) not rejoice?", "options": ["Ne te réjouis-tu pas?", "Tu te réjouis?", "Tu ne te réjouis pas?", "Tu réjouis?"], "answer": "A"},
      {"question": "Does he rejoice?", "options": ["Il se réjouit?", "Se réjouit-il?", "Il réjouit?", "Il se réjouis?"], "answer": "A"},
      ...
      {"question": "You (vous) rejoice.", "options": ["Vous vous réjouissez.", "Réjouissez-vous?", "Vous réjouissez?", "Vous réjouir?"], "answer": "A"},
      {"question": "They (masc.) do not rejoice.", "options": ["Ils ne se réjouissent pas.", "Ils se réjouissent pas?", "Ils se réjouissent?", "Ne se réjouissent-ils pas?"], "answer": "A"},
      {"question": "Do you (vous) rejoice?", "options": ["Réjouissez-vous?", "Vous vous réjouissez?", "Vous réjouissez?", "Vous vous réjouissez-vous?"], "answer": "B"},
      ...
      {"question": "I do not rejoice.", "options": ["Je me réjouis pas.", "Je me réjouis?", "Je ne me réjouis pas.", "Je réjouis pas."], "answer": "C"},
      {"question": "She rejoices.", "options": ["Elle se réjouit.", "Se réjouit-elle?", "Elle réjouit?", "Elle réjouis?"], "answer": "A"},
      ...
      {"question": "She does not rejoice.", "options": ["Elle ne se réjouit pas.", "Elle réjouit pas.", "Elle se réjouit pas.", "Elle réjouis pas."], "answer": "A"},
      {"question": "You (vous) do not rejoice.", "options": ["Vous ne vous réjouissez pas.", "Vous réjouissez-vous pas?", "Vous réjouissez?", "Vous réjouis?"], "answer": "A"},
      {"question": "He does not rejoice.", "options": ["Il ne se réjouit pas.", "Il réjouit pas.", "Il se réjouit pas.", "Il réjouis pas."], "answer": "A"},
      {"question": "They (masc.) rejoice.", "options": ["Ils réjouissent?", "Ils se réjouissent.", "Ils ne se réjouissent pas.", "Ils réjouis?"], "answer": "B"},
      {"question": "Does she not rejoice?", "options": ["Se réjouit-elle?", "Elle se réjouit pas?", "Ne se réjouit-elle pas?", "Elle ne réjouit pas?"], "answer": "C"},
      {"question": "They (fem.) do not rejoice.", "options": ["Elles réjouissent pas.", "Elles se réjouissent pas.", "Elles se réjouissent?", "Elles ne se réjouissent pas."], "answer": "D"}
    ],
    "passé_composé": [
    ...
    "futur_simple": [
      ...
      {"question": "Will he rejoice?", "options": ["Se réjouira-t-il?", "Il se réjouira?", "Il réjouira?", "Il se réjouirait?"], "answer": "A"},
      ...
      {"question": "You (vous) will rejoice.", "options": ["Vous vous réjouirez.", "Réjouirez-vous?", "Vous réjouirez?", "Vous avez réjoui?"], "answer": "A"},
      {"question": "They (masc.) will not rejoice.", "options": ["Ils ne se réjouiront pas.", "Ils se réjouiront?", "Ne se réjouiront-ils pas?", "Ils se réjouiront pas?"], "answer": "A"},
      {"question": "Will you (vous) rejoice?", "options": ["Réjouirez-vous?", "Vous vous réjouirez?", "Vous réjouirez?", "Vous vous réjouirez-vous?"], "answer": "B"},
      ...
      {"question": "Will we not rejoice?", "options": ["Nous nous réjouirons?", "Ne nous réjouirons-nous pas?", "Réjouirons-nous?", "Nous ne nous réjouirons pas?"], "answer": "D"},
      {"question": "I will not rejoice.", "options": ["Je ne me réjouirai pas.", "Je me réjouirai pas.", "Je me réjouirai?", "Je n'ai pas réjoui."], "answer": "A"},
      {"question": "She will rejoice.", "options": ["Elle se réjouira.", "Réjouira-t-elle?", "Elle réjouirait?", "Elle ne se réjouira pas."], "answer": "A"},
      ...
      {"question": "She will not rejoice.", "options": ["Elle ne se réjouira pas.", "Elle se réjouira pas.", "Elle réjouirait pas.", "Réjouira-t-elle?"], "answer": "A"},
      {"question": "You (vous) will not rejoice.", "options": ["Vous ne vous réjouirez pas.", "Vous réjouirez pas?", "Vous vous réjouirez pas.", "Vous avez réjoui?"], "answer": "A"},
      {"question": "He will not rejoice.", "options": ["Il ne se réjouira pas.", "Il se réjouira pas.", "Il réjouirait pas.", "Il se réjouirait?"], "answer": "A"},
      ...
      {"question": "Will she not rejoice?", "options": ["Ne se réjouira-t-elle pas?", "Elle se réjouira pas?", "Se réjouira-t-elle pas?", "Elle réjouira pas?"], "answer": "A"},
      {"question": "They (fem.) will not rejoice.", "options": ["Elles ne se réjouiront pas.", "Elles réjouiront pas.", "Elles se réjouiront pas.", "Elles réjouiront?"], "answer": "A"}
    ]
  },
