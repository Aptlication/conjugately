...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "s'intéresser": {
    ...
    "passé_composé": [
      ...
      {"question": "What did you become interested in? (Informal)", "options": ["À quoi t'es-tu intéressé(e) ?", "À quoi tu t'es intéressé(e) ?", "À quoi as-tu intéressé ?", "À quoi est-ce que tu t'es intéressé(e) ?"], "answer": "A"},
