...
export const INTERMEDIATE_QUIZ_DATA: Record<string, Record<string, IntermediateQuizQuestion[]>> = {
  ...
  "se débrouiller": {
    "present": [
      ...
      {"question": "She manages perfectly.", "options": ["Elle ne se débrouille pas parfaitement.", "Elle débrouille parfaitement.", "Elle se débrouilles parfaitement.", "Elle se débrouille parfaitement."], "answer": "D"},
